...
def load_type_ids_json(filename='typeid.json'):
...
def find_type_id_by_name_local(name, filename='typeid.json'):
...
def find_type_name_by_id_local(type_id, filename='typeid.json'):
	type_dict_by_id, _ = load_type_ids_json(filename)
	return type_dict_by_id.get(type_id, None)

def load_blueprints_materials(filename='blueprints_materials.json'):
	with open(filename, encoding='utf-8') as f:
		return json.load(f)

def get_blueprint_materials(type_id, materials_filename='blueprints_materials.json', typeid_filename='typeid.json'):
...
def get_blueprint_materials_by_name(item_name, materials_filename='blueprints_materials.json', typeid_filename='typeid.json'):
